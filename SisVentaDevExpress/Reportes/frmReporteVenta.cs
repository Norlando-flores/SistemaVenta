    ...
    public partial class frmReporteVenta : Form
    {
        ...
        public void printInvoice(Venta v)
        {
            ...
            foreach (DevExpress.XtraReports.Parameters.Parameter p in report.Parameters)           
                p.Visible = false;
            report.intData(v.IdVenta, v.Tipo_Comprobante, v.Serie, v.Correlativo, v.Fecha, v.IdCliente.NombreCompleto,v.IdCliente.Tipo_Documento,v.IdCliente.Num_Documento,v.IdCliente.Direccion,v.IdCliente.Telefono);
